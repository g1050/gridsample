...
// /// @brief 将归一化的坐标（-1 到 1）转换为实际的像素索引，基于图像的大小和 align_corners 标志
// /// @tparam scalar_t 
// /// @param coord 
// /// @param size 
// /// @param align_corners 
...
// /// @brief 确保坐标在图像的有效范围内（即在0到图像宽高范围内）
// /// @tparam scalar_t 
// /// @param in 
// /// @param clip_limit 
// /// @return 
...
// /// @brief 
// /// @tparam scalar_t 将坐标反射回有效的图像边界内。用于反射填充模式。
// /// @param in 
// /// @param twice_low 
// /// @param twice_high 
// /// @return 
...
// /// @brief 根据选择的填充模式（如边界填充、反射填充等）调整坐标，并进行裁剪。
// /// @tparam scalar_t 
// /// @param coord 
// /// @param size 
// /// @param padding_mode 
...
// /// @brief 通过去归一化和根据填充模式调整坐标来计算最终的源索引。
// /// @tparam scalar_t 
// /// @param coord 
// /// @param size 
// /// @param padding_mode 
